...
* **Public Repository Search (GitHub API)**: Integrated live search querying the real GitHub REST API (`https://api.github.com/search/repositories?q={query}`) with instant results, star counts, programming languages, topic chips, and direct external links.
